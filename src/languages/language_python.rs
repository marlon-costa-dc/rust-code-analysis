...
pub enum Python {
    ...
    ModuleRepeat1 = 240,
    SimpleStatementsRepeat1 = 241,
    ImportPrefixRepeat1 = 242,
    ImportListRepeat1 = 243,
    PrintStatementRepeat1 = 244,
    AssertStatementRepeat1 = 245,
    IfStatementRepeat1 = 246,
    MatchStatementRepeat1 = 247,
    MatchBlockRepeat1 = 248,
    CaseClauseRepeat1 = 249,
    TryStatementRepeat1 = 250,
    ExceptClauseRepeat1 = 251,
    WithClauseRepeat1 = 252,
    GlobalStatementRepeat1 = 253,
    TypeParameterRepeat1 = 254,
    ArgumentListRepeat1 = 255,
    DecoratedDefinitionRepeat1 = 256,
    DottedNameRepeat1 = 257,
    UnionPatternRepeat1 = 258,
    DictPatternRepeat1 = 259,
    ParametersRepeat1 = 260,
    PatternsRepeat1 = 261,
    ComparisonOperatorRepeat1 = 262,
    SubscriptRepeat1 = 263,
    DictionaryRepeat1 = 264,
    ComprehensionClausesRepeat1 = 265,
    CollectionElementsRepeat1 = 266,
    ForInClauseRepeat1 = 267,
    ConcatenatedStringRepeat1 = 268,
    StringRepeat1 = 269,
    StringContentRepeat1 = 270,
    FormatSpecifierRepeat1 = 271,
    AsPatternTarget = 272,
...
impl From<Python> for &'static str {
    ...
    fn from(tok: Python) -> Self {
        match tok {
            ...
            Python::ExceptClauseRepeat1 => "except_clause_repeat1",
